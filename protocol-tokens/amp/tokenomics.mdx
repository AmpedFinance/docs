...
description: 'Comprehensive overview of AMP token distribution and vesting schedules'
---

# AMP Tokenomics

Amped Finance has a total supply of **100 million AMP tokens** distributed across various stakeholders to ensure long-term sustainability, reward early supporters, and incentivize platform usage.
...
<iframe 
  ...
  title="AMP Token Distribution Timeline"
/>

## Distribution Overview

The 100 million AMP tokens are allocated across the following categories:
...
The distribution schedule is designed to align with AMP's core utilities:
...
For more details about AMP's utility and staking mechanisms, see our [AMP Token Overview](/protocol-tokens/amp/overview) and [Holding AMP](/protocol-tokens/amp/holding-amp) guides. 