...
1. **Trading Fees**: A portion of all trading fees generated on the platform
2. **Liquidation Fees**: Fees collected from liquidated positions
3. **Swap Fees**: Fees from token swaps within the protocol
...
- Rewards are network-specific (Berachain rewards are separate from Lightlink rewards)
